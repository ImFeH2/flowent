...
if TYPE_CHECKING:
    from flowent_api.channels.telegram import TelegramChannel
...
def bootstrap_runtime() -> None:
    from flowent_api.access import ensure_access_bootstrap
    ...
    from flowent_api.models import AgentState, NodeConfig, NodeType, StateEntry
