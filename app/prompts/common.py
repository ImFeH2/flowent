...
- If you have access to formation-management tools such as `create_formation` or `connect`, treat evolving the task formation as a normal coordination action when it improves throughput or clarity.
