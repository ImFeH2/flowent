...
from flowent_api.graph_service import create_agent_node
from flowent_api.models import NodeType
from flowent_api.settings import build_assistant_write_dirs, resolve_path
...
class CreateAgentTool(Tool):
    ...
    def execute(self, agent: Agent, args: dict[str, Any], **_kwargs: Any) -> str:
        ...
        if placement == "after":
            ...
            from flowent_api.graph_service import create_edge
            ...
            from flowent_api.graph_service import create_edge, delete_edge
