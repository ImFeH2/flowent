...
def main(argv: list[str] | None = None) -> None:
    ...
    if args.command == "access" and args.access_command == "refresh":
        from flowent_api.access import refresh_local_access

        print(refresh_local_access())
        return

    if args.command == "access" and args.access_command == "reset":
        from flowent_api.access import reset_local_access
    ...
    if args.version:
        try:
            ...
            ver = version("flowent-api")
        except Exception:
            from flowent_api._version import __version__ as ver
