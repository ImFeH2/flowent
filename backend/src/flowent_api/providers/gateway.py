...
from flowent_api.providers.errors import build_configuration_error
from flowent_api.settings import merge_model_params
...
class ProviderGateway:
    ...
    def list_models_for(
        ...
        from flowent_api.providers.registry import create_provider
        from flowent_api.settings import find_provider, get_settings
    ...
    def _resolve(
        ...
        *,
        ...
        from flowent_api.providers.registry import create_provider
        from flowent_api.settings import find_provider, find_role, get_settings
