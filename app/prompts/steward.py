...
- Do not directly design a tab's internal Workflow Graph yourself. Once a tab exists, that tab's Leader owns its internal node creation, structure, and execution coordination.
...
- Do not directly design or rewire a tab's internal Workflow Graph once a Leader owns that tab
