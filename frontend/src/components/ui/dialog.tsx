...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        "fixed inset-0 z-50 bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.06),transparent_22%),rgba(3,6,11,0.78)] backdrop-blur-md",
